                    ...
                    <Fade right>
                        <div>
                            <div className={s.section1ContentWrapper}>
                                <h1>Washd<br/>was founded <span>to optimize</span></h1>
                                <h4>
                                    the work in laundries using RFID tags. This allows
                                    to minimize the loss of clothing and, no less important, to save the environment. The RFID tag
                                    will be steamed on the clothes. This tag will contain information about the clothing and its owners.
                                    You will be able to wash more clothes with each washing machine, saving the environment by using less electricity, water and detergents.
                                </h4>
                            </div>
                        </div>
                    </Fade>
                ...
                <div className={s.howitworks1}>
                    <Rotate top left>
                        <div className={s.cardWrapper}>
                            ...
                            <div className={s.cardDescription}>
                                <h4>By washing more clothes with each washing machine, you use less water and take care
                    ...
                    <Roll right>
                        <div className={s.cardWrapper}>
                            ...
                            <div className={s.cardDescription}>
                                <h4>All that extra detergents are not just a waste of money, it gunks up your machine and shorten the service life of the appliance.</h4>
                            </div>
                        </div>
                    </Roll>
                    <Rotate top right>
                        <div className={s.cardWrapper}>
                            ...
                            <div className={s.cardDescription}>
                                <h4>You will consume less electricity and save money by washing more clothes with each washing machine.</h4>
                            </div>
                        </div>
                    </Rotate>
                </div>
                <div className={s.howitworks2}>
                        ...
                        <div className={s.cardWrapper}>
                            ...
                            <div className={s.cardDescription}>
                                <h4>Washd is programmed so that people
                                    with disabilities (hearing impairment, visual impairment, etc) easily can use the system.</h4>
                            </div>
                        </div>
                    </Rotate>
                    <Flip top>
                    ...
                    <Rotate bottom right>
                        <div className={s.cardWrapper}>
                            ...
                            <div className={s.cardDescription}>
                                <h4>You will get full controll of where all the garments in your laudry are located, all the time, by using new RFID tracking system.</h4>
                            </div>
                        </div>
                    </Rotate>
                </div>
