  ...
  const cards = [
    {
      ...
      text:
        "This tag will contain the name, address of the owner, what kind of clothes, what kind of fabric," +
    ...
    },
    {
      ...
      text:
        "Zebra scanner scans a bag of clothes with RFID tags and allows you to instantly see how many" +
    ...
    },
    {
      ...
      text:
        "Wash, dry and fold the clothes and use the scanner to quickly determine which clothes belong to" +
  ...
  const accordionData = [
    {
      ...
      content:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac feugiat adipiscing eu augue commodo" +
      ...
      <div className={s.mobilePadding}>
        <Element name="about-us" className="element">
          <section className={s.section1}>
            <Fade left>
              <div>
                <LazyLoadImage width={"100%"} src={img1} alt={"image"} />
              </div>
            </Fade>
            <Fade right>
              <div>
                <div className={s.section1ContentWrapper}>
                  <h1>
                    Washd <br />
                    was founded <span>to optimize</span>
                  </h1>
                  <h4>
                    the work in laundries using RFID tags. This allows to
                    minimize the loss of clothing and, no less important, to
                    save the environment. The RFID tag will be steamed on the
                    clothes. This tag will contain information about the
                    clothing and its owners. You will be able to wash more
                    clothes with each washing machine, saving the environment by
                    using less electricity, water and detergents.
                  </h4>
                </div>
              </div>
            </Fade>
          ...
          <div className={s.howitworks1}>
            <Rotate top left>
              <div className={s.cardWrapper}>
                ...
                <div className={s.cardDescription}>
                  <h4>
                    By washing more clothes with each washing machine, you use
                    less water and take care of the environment.
                  </h4>
                </div>
              </div>
            </Rotate>
            <Roll right>
              <div className={s.cardWrapper}>
                ...
                <div className={s.cardDescription}>
                  <h4>
                    All that extra detergents are not just a waste of money, it
                    gunks up your machine and shorten the service life of the
                    appliance.
                  </h4>
                </div>
              </div>
            ...
            <Rotate top right>
              <div className={s.cardWrapper}>
                ...
                <div className={s.cardDescription}>
                  <h4>
                    You will consume less electricity and save money by washing
                    more clothes with each washing machine.
                  </h4>
                </div>
              </div>
            </Rotate>
          ...
          <div className={s.howitworks2}>
            <Rotate bottom left>
              <div className={s.cardWrapper}>
                ...
                <div className={s.cardDescription}>
                  <h4>
                    Washd is programmed so that people with disabilities
                    (hearing impairment, visual impairment, etc) easily can use
                    the system.
                  </h4>
                </div>
              </div>
            ...
            <Flip top>
              <div className={s.cardWrapper}>
                ...
                <div className={s.cardDescription}>
                  <h4>
                    Washd can be integrated with other programs such as ERP
                    systems and warehouse systems.
                  </h4>
                </div>
              </div>
            </Flip>
            <Rotate bottom right>
              <div className={s.cardWrapper}>
                ...
                <div className={s.cardDescription}>
                  <h4>
                    You will get full controll of where all the garments in your
                    laudry are located, all the time, by using new RFID tracking
                    system.
                  </h4>
                </div>
              </div>
        ...
        <section className={s.section4}>
          ...
          <Breakpoint customQuery="(min-width: 769px)">
            <div className={s.companiesContainer}>
              <Fade bottom>
                <LazyLoadImage src={company1} alt="Innovasion Norge" />
                <LazyLoadImage src={company2} />
                <LazyLoadImage src={company3} />
                <LazyLoadImage src={company4} alt="Zebra" />
              </Fade>
            </div>
          </Breakpoint>
          <Breakpoint customQuery="(max-width: 768px)">
            <div className={s.companiesContainerMobile}>
              <Fade bottom>
                <div>
                  <LazyLoadImage src={company1mobile} alt="Innovasion Norge" />
                  <LazyLoadImage src={company2mobile} />
                </div>
                <div>
                  <LazyLoadImage src={company3mobile} />
                  <LazyLoadImage src={company4mobile} alt="Zebra" />
                </div>
              </Fade>
            </div>
          </Breakpoint>
              ...
              <div className={s.faqSubHeader}>
                <div>
                  <p>
                    ...
                    <br />
                    You can ask us at anytime. Contact us
                  </p>
      ...
      <Breakpoint customQuery="(min-width: 768px)">
        <section className={s.section7}>
          <div className={s.startWorkingWrapper}>
            <h1>
              Start working <br /> with <span>Washd</span> now
            </h1>
            <div onClick={handleGetStartedModal}>
              <HeadShake>
      ...
      <Breakpoint customQuery="(max-width: 767px)">
        <section className={s.section7Mob}>
          <div className={s.startWorkingWrapperMob}>
            <div>
              <img
                src={startWorkingImgMobile}
                alt="start-working-mobile"
                height="100%;"
              />
            </div>
            <div className={s.startWorkingText}>
              <h1>
                Start working with <span>Washd</span> now
              </h1>
              <div onClick={handleGetStartedModal}>
                <HeadShake>
